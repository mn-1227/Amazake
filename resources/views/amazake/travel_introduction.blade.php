        ...
        <div class="col-md-12">
          <div class="carousel slide" data-ride="carousel" id="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active"> <img class="d-block img-fluid w-100" src="{{$travel_int->image_path1}}" width="300">
              </div>
              <div class="carousel-item"> <img class="d-block img-fluid w-100" src="{{$travel_int->image_path2}}" width="300">
                <div class="carousel-caption">
                  <h5 class="m-0">Carousel</h5>
                  <p>with controls</p>
                </div>
              </div>
              <div class="carousel-item"> <img class="d-block img-fluid w-100" src="{{$travel_int->image_path3}}" width="300">
              </div>
