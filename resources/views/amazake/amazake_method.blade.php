        ...
        <div class="col-md-4">
          <div class="card"> <img class="card-img-top" src="{{ secure_asset('image/甘酒シンプル_s.jpg') }}" alt="Card image cap" height="300">
            <div class="card-body">
              ...
              <p class="card-text">甘さ、米麹の粒感、甘酒独特のクセの強さ、量あたりの値段から、自分にあった甘酒を探してみましょう。</p> <a href="#" class="btn btn-primary" contenteditable="true">好みから探すへ</a>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card" style=""> <img class="card-img-top border border-info" src="{{ secure_asset('image/map-japan-deform-prefecture-01.png') }}" alt="Card image cap" style="" height="300">
            <div class="card-body">
              ...
              <p class="card-text">製造している場所から甘酒を探してみましょう。地図をクリックすると、その場所で製造された甘酒が表示されます。</p> <a href="#" class="btn btn-primary">場所から探すへ</a>
            </div>
          </div>
        </div>
        <div class="col-md-4">
