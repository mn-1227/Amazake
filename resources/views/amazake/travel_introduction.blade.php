        ...
        <div class="col-md-6">
          <div class="carousel slide" data-ride="carousel" id="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item"> <img class="d-block img-fluid mx-auto" src="{{$travel_int->image_path2}}" width="300">
                
              </div>
              <div class="carousel-item"> <img class="d-block img-fluid mx-auto" src="{{$travel_int->image_path3}}" width="300">
              </div>
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body" >
              ...
              <a href="{{ $travel_int->link }}" class="card-link">行ったのはここ！</a>
            </div>
          </div>
        </div>
      </div>
